      ...
      <div className="contact-container">
        ...
        <div className="contact-content">
          ...
          >
            <form onSubmit={handleSubmit} className="contact-form">
              <div className="form-grid">
                ...
                {/* Phone */}
                <div className="form-field">
                  <label htmlFor="phone">{contactContent.form.fields.phone.label}</label>
                  <input
                    type="tel"
                    id="phone"
                    name="phone"
                ...
                {/* Company */}
                <div className="form-field">
                  <label htmlFor="company">{contactContent.form.fields.company.label}</label>
                  <input
                    type="text"
                    id="company"
                    name="company"
                ...
                >
                  {isSubmitting ? (
                    ...
                    <>
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="button-icon">
          ...
          >
            ...
            <div className="info-card">
              <h3 className="info-title">{contactContent.businessHours.title}</h3>
